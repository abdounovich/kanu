...
<div class="container">
    <div class="row">
        ...
        <div class="h3 p-2   d-flex align-self-center">عدد الزبائن :  </div>
        ...
        <div class="col col-4 ">  <div class="card rounded bg-danger text-white p-2 shadow" style="opacity: 0.8" >
            ...
            <div class="h3 p-2   d-flex align-self-center">عدد المواعيد :  </div>
        ...
        <div class="col col-4 ">  <div class="card rounded bg-success text-white p-2 shadow" style="opacity: 0.8" >
            ...
            <div class="h3 p-2   d-flex align-self-center">عدد الأنواع  :  </div>
