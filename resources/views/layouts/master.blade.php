<html>
    <head>
        ...
        <script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script><style>
...
<a href="/rdv" class=" col col-2 text-white btn btn-dark m-2 p-2" style="font-size: 60px"><i class=" p-2 fa fa-calendar"></i></a> 

            <a href="/clients" class="col col-2  text-white btn btn-info m-2 p-2" style="font-size: 60px"> <i class=" p-2 fa fa-users"></i></a> 
                      <a class=" col col-2   text-white btn btn-danger m-2 p-2 " style="font-size: 60px" data-toggle="modal" data-target="#exampleModal" ><i class=" p-2 fa fa-power-off"></i> </a>
            <a id="button" class="col col-2  text-white btn btn-warning m-2 p-2"  style="font-size: 60px"> <i class=" p-2 fa fa-refresh"></i></a> 
