...
<a href="/rdv" class=" col col-2 text-white btn btn-warning m-2 p-2" style="font-size: 60px"><i class=" p-2 fa fa-calendar"></i></a> 

            <a href="/clients" class="col col-2  text-white btn btn-info m-2 p-2" style="font-size: 60px"> <i class=" p-2 fa fa-users"></i></a> 
            <a href="/clients" class="col col-2  text-white btn btn-danger m-2 p-2" style="font-size: 60px"> <i class=" p-2 fa fa-wrench"></i></a> 
