...
<div id="site_settings" class="container bg-dark mt-4">


<form action="{{url('parametres/theme/update')}}" method="post"  enctype="multipart/form-data">
    @csrf
    <div class="row mt-4 p-2">
    <div class="col col-2 p-2">
        <label  class="h4 text-white" for="primary" >اللون الأول </label>
       </div>
       <div class="col col-1 p-2">
        <input type="color" value="{{Setting::get('Theme.primary-color')}}" class="form-control form-control-color" name="primary" id="">
    </div>

    <div class="col col-2 p-2">
        <label  class="h4 text-white" for="secondary" >اللون الثاني </label>
       </div>
       <div class="col col-1 p-2">
        <input type="color" value="{{Setting::get('Theme.secondary-color')}}" class="form-control" name="secondary" id="">
    </div>

    <div class="col col-2 p-2">
        <label  class="h4 text-white" for="text-color" >  لون النصوص   </label>
       </div>
       <div class="col col-1 p-2">
        <input type="color" value="{{Setting::get('Theme.text-color')}}" class="form-control" name="text-color" id="">
    </div>
    </div>
    <div class="row">
    <div class="col col-2 p-2">
        <label  class="h4 text-white" for="text-color" >  صورة  الخلفية   </label>
       </div>
...
<img class="img rounded border border-2" id="image" 
